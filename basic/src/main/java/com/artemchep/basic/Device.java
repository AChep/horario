...
public class Device {
    ...
    static {
        switch (API_VERSION) {
            ...
            case Build.VERSION_CODES.N_MR1:
                API_VERSION_NAME_SHORT = "N1";
                break;
            default:
                API_VERSION_NAME_SHORT = "API=" + API_VERSION;
        }
    }
     ...
     * {@link Build.VERSION_CODES#N_MR1 Nougat 7.1} or higher, {@code false} otherwise.
     */
    public static boolean hasNougatMr1Api() {
        return hasTargetApi(Build.VERSION_CODES.N_MR1);
    }

    /**
     * @return {@code true} if device is running
     * {@link Build.VERSION_CODES#N Nougat 7} or higher, {@code false} otherwise.
     */
