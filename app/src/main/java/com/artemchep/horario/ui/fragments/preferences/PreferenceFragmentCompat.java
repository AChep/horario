...
import com.artemchep.horario.utils.PreferenceManagerUtils;
 ...
 * <p>
 * To specify an {@link Intent} to query {@link android.app.Activity Activities} that each
 ...
 * <p>For information about using {@code PreferenceFragmentBase},
...
public abstract class PreferenceFragmentCompat extends Fragment implements
    ...
    private static class H extends Handler {
        ...
        private final WeakReference<PreferenceFragmentCompat> mRef;

        H(@NonNull PreferenceFragmentCompat object) {
        ...
        public void handleMessage(Message msg) {
            ...
            PreferenceFragmentCompat pfb = mRef.get();
            if (pfb != null) switch (msg.what) {
    ...
    /**
     * Interface that PreferenceFragmentBase's containing activity should
