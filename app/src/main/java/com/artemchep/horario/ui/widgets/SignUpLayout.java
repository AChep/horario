...
public class SignUpLayout extends SignInLayout {
    ...
    protected void onFinishInflate() {
        ...
        mPasswordConfirmEditText = (TextInputEditText) findViewById(R.id.input_password_confirm);
        mPasswordConfirmInputLayout = (TextInputLayout) findViewById(R.id.input_layout_password_confirm);
