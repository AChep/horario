...
public class AuthFragment extends Fragment implements
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mSignInView = (SignInLayout) content.findViewById(R.id.sign_in_layout);
        ...
        MaterialDialog.SingleButtonCallback positiveCallback =
                new MaterialDialog.SingleButtonCallback() {
                    ...
                    public void onClick(
                        ...
                        assert view != null;
                        EmailInputLayout emailLayout = (EmailInputLayout) view
    ...
    private void showRegisterDialog() {
        ...
        MaterialDialog.SingleButtonCallback positiveCallback =
                new MaterialDialog.SingleButtonCallback() {
                    ...
                    public void onClick(
                        ...
                        View view = dialog.getCustomView();
                        assert view != null;
                        SignUpLayout sul = (SignUpLayout) view
        ...
        if (TextUtils.isEmpty(email)) {
            ...
            EditText editText = (EditText) v.findViewById(R.id.input_email);
        ...
        if (TextUtils.isEmpty(password)) {
            ...
            EditText editText = (EditText) v.findViewById(R.id.input_password);
